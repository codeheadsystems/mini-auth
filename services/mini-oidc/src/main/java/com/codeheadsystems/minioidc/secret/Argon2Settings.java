...
/**
 * Tunable Argon2id cost parameters used when hashing service-account secrets.
 *
 ...
 * without invalidating existing service-account secrets (verification reads back the stored values).
 *
