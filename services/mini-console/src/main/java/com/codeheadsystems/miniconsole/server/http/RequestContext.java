 ...
 * and convenience accessors for the body, headers, cookies, and form fields.
 *
 * <p>This keeps {@link com.sun.net.httpserver.HttpExchange} at arm's length so handlers deal in
 * small, testable accessors rather than the raw servlet-like API. A verbatim copy of mini-oidc's
 * {@code server/http/RequestContext}.
 */
public final class RequestContext {
  ...
  /** @return the decoded query-string parameters. */
   ...
   *
   * <p>Used by the login/logout POSTs, whose fields (the pasted token, the CSRF token) arrive as a
   * form. Percent-decoding is applied to both names and values.
   */
