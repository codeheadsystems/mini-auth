 ...
 *
 * <p>It is the bootstrap credential that guards certificate issuance, renewal, revocation, and the
 * issuance log — only an authorized operator (or a mini holding the token) may mint certs.
 */
