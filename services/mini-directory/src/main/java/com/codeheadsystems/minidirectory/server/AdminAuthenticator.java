 ...
 *
 * <p>It is the bootstrap credential that lets an operator populate the directory — create humans,
 * service accounts, groups, and roles, and assign grants — before any directory identities exist.
 */
